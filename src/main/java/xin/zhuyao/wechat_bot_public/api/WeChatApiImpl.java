package xin.zhuyao.wechat_bot_public.api;
...
import xin.zhuyao.wechat_bot_public.api.client.BotClient;
import xin.zhuyao.wechat_bot_public.api.constant.Constant;
import xin.zhuyao.wechat_bot_public.api.constant.StateCode;
...
import xin.zhuyao.wechat_bot_public.api.model.*;
import xin.zhuyao.wechat_bot_public.api.request.BaseRequest;
import xin.zhuyao.wechat_bot_public.api.request.FileRequest;
import xin.zhuyao.wechat_bot_public.api.request.JsonRequest;
import xin.zhuyao.wechat_bot_public.api.request.StringRequest;
import xin.zhuyao.wechat_bot_public.api.response.*;
import xin.zhuyao.wechat_bot_public.exception.WeChatException;
import xin.zhuyao.wechat_bot_public.utils.*;
...
import static xin.zhuyao.wechat_bot_public.api.enums.MsgType.*;
...
public class WeChatApiImpl implements WeChatApi {
    ...
    private WeChatMessage processMsg(Message message) {
        ...
        if (message.isGroup()) {
            ...
            if (message.getFromUserName().contains(Constant.GROUP_IDENTIFY) &&
                    !groupUserNames.contains(message.getFromUserName())) {
                this.groupUserNames.add(message.getFromUserName());
            }
            if (message.getToUserName().contains(Constant.GROUP_IDENTIFY) &&
        ...
        switch (message.msgType()) {
            case TEXT:
                ...
                // 位置消息
                if (content.contains(Constant.LOCATION_IDENTIFY)) {

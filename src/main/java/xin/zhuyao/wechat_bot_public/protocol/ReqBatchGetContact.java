...
public class ReqBatchGetContact {
    public final xin.zhuyao.wechat_bot_public.protocol.BaseRequest BaseRequest;
    public final int Count;
    public final List<Contact> List;

    public ReqBatchGetContact(xin.zhuyao.wechat_bot_public.protocol.BaseRequest baseRequest, List<Contact> contacts) {

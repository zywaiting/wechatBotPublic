...
public class ReqUploadMedia {
    ...
    public ReqUploadMedia(BaseRequest baseRequest, long clientMediaId, int uploadType, long totalLen, long startPos, long dataLen, String fileMd5, String aesKey, String signature, String fromUserName, String toUserName) {

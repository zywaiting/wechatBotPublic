...
public class ReqVerifyUser {
    ...
    public ReqVerifyUser(xin.zhuyao.wechat_bot_public.protocol.BaseRequest baseRequest, int opCode, String userName, String verifyTicket, String verifyContent) {
